fbq.version = "2.9.89", fbq._releaseSegment = "stable", fbq.pendingConfigs = ["global_config"], fbq.__openBridgeRollout = 1,
    function(e, t, n, r) {
        var s = {
            exports: {}
        };
                                                    ...
                                                    if (null != l.type && "string" == typeof l.type) {
                                                        ...
                                                        switch (l.type) {
                                                            case s:
                                                                ...
                                                                break;
                                                            case i:
                                                                p = "string" == typeof g && !!a[g.toUpperCase()]
                                                        }
                                                        if (!p) return d({
                                                            eventName: e,
                                                            param: u,
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    var e = r.getFbeventsModules("SignalsFBEventsQE"),
                                        ...
                                        u = r.getFbeventsModules("SignalsFBEventsBufferConfigTypedef"),
                                        l = r.getFbeventsModules("SignalsFBEventsDefaultCustomDataConfigTypedef"),
                                        c = r.getFbeventsModules("SignalsFBEventsTyped"),
                                        f = c.coerce,
                                        g = c.Typed;
                                    c = r.getFbeventsModules("SignalsFBEventsOpenBridgeConfigTypedef");
                                    var p = r.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
                                        v = r.getFbeventsModules("signalsFBEventsCoercePixelID"),
                                        E = r.getFbeventsModules("signalsFBEventsCoerceBatchingConfig"),
                                        b = r.getFbeventsModules("signalsFBEventsCoerceAutomaticMatchingConfig"),
                                        _ = r.getFbeventsModules("signalsFBEventsCoerceInferedEventsConfig"),
                                    ...
                                    h = function() {
                                        ...
                                        return i(t, [{
                                            ...
                                            value: function(e, t, n) {
                                                null != (e = null == e ? y : v(e)) && null != (t = f(t, g.string())) && null != this._configStore[t] && (this._configStore[t][e] = null != F[t] ? F[t](n) : n)
                                            }
                                        }, {
                                            key: "setExperimental",
                                            value: function(t) {
                                                if (null != (t = f(t, g.objectWithFields({
                                                        config: g.object(),
                                            ...
                                            key: "get",
                                            value: function(e, t) {
                                                return this._configStore[t][null != e ? e : y]
                                            }
                                        }, {
                                            ...
                                            value: function(e) {
                                                return m(new Error("Calling legacy api getAutomaticMatchingConfig")), this.get(e, "automaticMatching")
                                            }
                                        }, {
                                            key: "getInferredEventsConfig",
                                            value: function(e) {
                                                return m(new Error("Calling legacy api getInferredEventsConfig")), this.get(e, "inferredEvents")
                                            }
                                        }]), t
                                    }(), o.exports = new h
                                }(), o.exports
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    var v = r.getFbeventsModules("SignalsFBEventsOptIn"),
                                        ...
                                        _ = r.getFbeventsModules("SignalsFBEventsURLUtil"),
                                        h = _.getURLParameter,
                                        m = (_ = r.getFbeventsModules("SignalsPixelCookieUtils")).CLICK_ID_PARAMETER,
                                        y = _.readPackedCookie,
                                        F = _.CLICKTHROUGH_COOKIE_NAME,
                                        x = (_ = r.getFbeventsModules("SignalsFBEventsExperimentNames")).USE_FBC_AS_CACHE_KEY_EXPERIMENT,
                                        S = r.getFbeventsModules("SignalsFBEventsQE"),
                                        ...
                                        k = 3,
                                        D = {
                                            AutomaticSetup: _ = ["InferredEvents", "Microdata"]
                                        },
                                        L = {
                                    ...
                                    function j(e, t, n, r, s, o) {
                                        p.loadJSFile(function(e, t, n, r, s, o) {
                                            var i = new M((function(e) {
                                                return e
                                            }));
                                            return i.append("v", t), i.append("r", n), !0 === r && i.append("no_min", !0), null != s && "" != s && i.append("domain", s), null != o && "" != s && i.append("fbc", o), p.CONFIG.CDN_BASE_URL + "signals/config/" + e + "?" + i.toQueryString()
                                        }(e, t, n, s, r, o))
                                    }
                                    E = function() {
                                        function r(e, t) {
                                            var n = this;
                                            d(this, r), this.VALID_FEATURES = N, this.optIns = new v(D), this.configsLoaded = {}, this.locks = g.global, this.pluginConfig = u, this.disableFirstPartyCookies = !1, this.forceWeakPIICheck = !1, this.VERSION = e.version, this.RELEASE_SEGMENT = e._releaseSegment, this.pixelsByID = t, this.fbq = e, B(e.pendingConfigs || [], (function(e) {
                                        ...
                                        return i(r, [{
                                            ...
                                            value: function(e, t) {
                                                ...
                                                if ("string" != typeof t || !U(t)) throw new Error('Invalid Argument: "' + t + '" is not a valid opt-in feature');
                                                return U(t) && (this.optIns.optIn(e, t, r), B([t].concat(c(D[t] || [])), (function(e) {
                                            ...
                                            value: function(e, t, n, r, o, i) {
                                                if (e = "string" == typeof e ? e : e.id, !Object.prototype.hasOwnProperty.call(this.pixelsByID, e)) {
                                                    ...
                                                    return null == i ? A(a) : w(new Error(a.type + " " + a.pixelID)), this
                                                }
                                            ...
                                            value: function(e, t) {
                                                ...
                                                if (e.set && B(P(O(e.set), (function(e) {
                                            ...
                                            value: function(e) {
                                                var t = null != e.userData && O(e.userData).length > 0;
                                                return e = null != e.userDataFormFields && O(e.userDataFormFields).length > 0, t || e
                                            }
                                        }, {
                                            key: "fire",
                                            value: function(t) {
                                                ...
                                                return o.append("eid", i), r && B(O(r), (function(e) {
                                            ...
                                            value: function() {
                                                if (!S.isInTest(x) || !1 === b()) return "";
                                                var n = h(e.location.href, m);
                                                return null === n && (n = h(t.referrer, m)), null != n && n.includes("_aem_") && 2 === (n = n.split("_aem_")).length ? n[1] : null == (n = y(F)) || null == (n = n.payload) || 2 !== (n = n.split("_aem_")).length ? "" : n[1]
                                            }
                                        }, {
                                            key: "loadConfig",
                                            value: function(r) {
                                                if (!0 !== this.fbq.disableConfigLoading && !Object.prototype.hasOwnProperty.call(this.configsLoaded, r) && (this.locks.lockConfig(r), !this.fbq.pendingConfigs || !1 === T(this.fbq.pendingConfigs, (function(e) {
                                                    ...
                                                    var s, o = n.href,
                                                        i = t.referrer;
                                                    s = !1 === b() ? "" : e !== e.parent && null != i && "" !== i ? (i = new URL(i)).hostname : null != o || "" !== o ? (i = new URL(o)).hostname : "", j(r, this.VERSION, null != this.RELEASE_SEGMENT ? this.RELEASE_SEGMENT : "stable", s, this.fbq._no_min, this.getFBCWithAEMPayload())
                                                }
                                            }
                                        }, {
                                            key: "configLoaded",
                                ...
                                function() {
                                    ...
                                    function F(t, n) {
                                        try {
                                            ...
                                            (d && r < .01 || "canary" === o) && ((r = new a(null)).append("p", "pixel"), r.append("v", e.fbq && e.fbq.version ? e.fbq.version : "unknown"), r.append("e", t.toString()), s(t, Error) && (r.append("f", t.fileName), r.append("s", t.stackTrace || t.stack)), r.append("ue", n ? "1" : "0"), r.append("rs", o), u(r, {
                                    ...
                                    t = {
                                        ...
                                        logUserError: function(t) {
                                            ...
                                            Object.prototype.hasOwnProperty.call(h, n) || (h[n] = !0, _(n = function(e) {
                                                switch (e.type) {
                                                    ...
                                                    case "INVALID_FBQ_METHOD_PARAMETER":
                                                        ...
                                                        var n = e.invalidParamValue,
                                                            r = e.method,
                                                            s = e.params;
                                                        return "Call to \"fbq('" + r + "', " + y(s) + ');" with parameter "' + t + '" has an invalid value of "' + m(n) + '"';
                                                    ...
                                                    default:
                                                        return x(new Error("INVALID_USER_ERROR - " + e.type + " - " + JSON.stringify(e))), "Invalid User Error."
                                                }
                                            }(t)), function() {
                        ...
                        return function(e, t, n, s) {
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    var v = r.getFbeventsModules("SignalsFBEventsSendEventEvent"),
                                        E = (s = r.getFbeventsModules("SignalsFBEventsUtils")).some,
                                        b = r.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                                        _ = r.getFbeventsModules("generateUUID");
                                    (s = r.getFbeventsModules("SignalsFBEventsExperimentNames")).BATCHING_EXPERIMENT, s.DISALLOW_PII_ON_STRICT_NON_SUBMIT;
                                    ...
                                    o.exports = function(e) {
                                        ...
                                        if (!E(n, (function(e) {
                                            ...
                                            var r = e.eventName,
                                                s = u.isInTest(h);
                                            s = s && t, t = y(e), a.trigger(e.id, t);
                                            var o = !p(),
                                                l = Object.prototype.hasOwnProperty.call(e, "customData") && void 0 !== e.customData && null !== e.customData;
                                            if (l || (e.customData = {}), s && (l = _(), e.customData.rex = {
                                                    uid: l,
                                                    retry: 0
                                                }), o && "SubscribedButtonClick" === r) {
                                                if (s) return F(t, "POST", "SB", e.customData), void i.trigger("BEACON", t, n);
                                                if (c(t)) return void i.trigger("BEACON", t, n)
                                            }
                                            if (s && (l = t.toQueryString(), (r = b.ENDPOINT + "?" + l).length < 1978)) return F(t, "GET", "GET", e.customData), void i.trigger("GET", t, n);
                                            if (d(t)) i.trigger("GET", t, n);
                                                ...
                                                if (s) return F(t, "POST", "formPOST", e.customData), void i.trigger("POST", t, n);
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    o.exports = function n(r, s, o, i) {
                                        ...
                                        r.replaceObjectEntry("cd", i), u.withCredentials = !0, a = "GET" == o ? s + "?" + r.toQueryString() : s, u.open(o, a), u.onreadystatechange = function() {
                                            if (u.readyState === t && 200 !== u.status) {
                                                if (i.rex.retry >= 0) return void e(new Error("Reached the max number of retries for " + o));
                                                i.rex.retry += 1, setTimeout((function() {
                                                    n(r, s, o, i)
                                                }), 1e3)
                                            }
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    var b = {
                                        ...
                                        tuple: function(e) {
                                            return function(t) {
                                                return p((t = g(t, c())).length === e.length), t.map((function(t, n) {
                                                    return g(t, e[n])
                                                }))
                                            }
                                        },
                            ...
                            return s.exports,
                                function() {
                                    ...
                                    function v(e) {
                                        ...
                                        if (f)
                                            for (n = 0; n < p; n++) c.call(e, g[n]) && t.push(g[n]);
                                        return t
                                    }
                                    ...
                                    F = {
                                        ...
                                        reduce: function(e, t, n) {
                                            ...
                                            for (; o < s;) o in r && (n = t(n, r[o], o, e)), o++;
                                            return n
                                        },
                                        some: function(e, t) {
                                            return b.call(e, t)
                        ...
                        return function(e, t, n, s) {
                            ...
                            return o.exports,
                                function() {
                                    ...
                                    var e = r.getFbeventsModules("SignalsFBEventsBaseEvent");
                                    e = new e((function(e) {
                                        return e = null != e && "string" == typeof e && "" !== e ? e : null
                                    })), o.exports = e
                                }(), o.exports
                        }()
                    ...
                    return o.exports,
                        function() {
                            ...
                            o.exports = new a((function(r, s) {
                                ...
                                })), g.getItem(f) ? v() : e.opener && e.addEventListener("message", (function(e) {
                                    var t = e.data,
                                        n = t.graphToken,
                                        r = t.msg_type,
                                        o = t.pixelID;
                        ...
                        function() {
                            ...
                            function m() {
                                var e = 0,
                                    ...
                                    n = 0;
                                try {
                                    e = p(b(), u.IS_SELENIUM), t = p(_(), u.IS_HEADLESS)
                                } catch (e) {
                                ...
                                if (!f) {
                                    ...
                                    r.listen((function(e) {
                                        ...
                                        var r = t.optIns,
                                            i = p(null != n && r.isOptedOut(n.id, "AutomaticSetup"), u.AUTO_CONFIG_OPT_OUT);
                                        ...
                                        var a = p(!0 !== e.disableConfigLoading, u.CONFIG_LOADING),
                                            ...
                                            f = p(g(), u.SUPPORTS_SEND_BEACON),
                                            v = p(null != n && o[n.id], u.HAS_CONFLICTING_PII),
                                            E = p(null != n && s[n.id], u.HAS_INVALIDATED_PII);
                                        n = p(null != n && c[n.id], u.HAS_AUTOMATCHED_PII);
                                        var b = p(l.getShouldProxy(), u.SHOULD_PROXY),
                                            _ = m();
                                        return {
                                            o: i = i | r | a | d | f | E | b | _.isHeadless | _.isSelenium | _.hasDetectionFailed | v | n
                                        }
                                    })), f = !0
                                }
                            ...
                            return s.exports,
                                function() {
                                    ...
                                    var c = l.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                                        ...
                                        _ = l.getFbeventsModules("SignalsFBEventsJSLoader"),
                                        h = l.getFbeventsModules("SignalsFBEventsFireLock"),
                                        m = l.getFbeventsModules("SignalsFBEventsMobileAppBridge"),
                                        y = l.getFbeventsModules("signalsFBEventsInjectMethod"),
                                        F = l.getFbeventsModules("signalsFBEventsMakeSafe"),
                                        x = l.getFbeventsModules("signalsFBEventsResolveLegacyArguments"),
                                        S = l.getFbeventsModules("SignalsFBEventsPluginManager"),
                                    ...
                                    function ae(e) {
                                        ...
                                        switch (e) {
                                            ...
                                            case "autoConfig":
                                                ...
                                                ne.callMethod([g, f, "AutomaticSetup"]);
                                                break;
                                            ...
                                            case "trackSingleOnly":
                                                ...
                                                var R = E.validateMetadata(e);
                                                R.error && W(R.error), R.warnings && R.warnings.forEach((function(e) {
                                                    W(e)
                                                })), J.call(ee, N) ? ee[N].trackSingleOnly = A : W({
                                                    metadataValue: e,
                                                    pixelID: N,
                                                ...
                                                break;
                                            default:
                                                var C = ne.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                                                    k = null != C && C.dataProcessingOptions.includes("LDU"),
                                                    D = n[0],
                                                    U = n[1];
                                    ...
                                    function de(e, t, n) {
                                        t = t || {}, E.validateEventAndLog(e, t), "CustomEvent" === e && "string" == typeof t.event && (e = t.event), fe.call(this, e, t, n)
                                    }

                                    function fe(e, t, n) {
                                        for (var r = 0, s = Z.length; r < s; r++) {
                                            var o = Z[r];
                                            ("PageView" === e && this.allowDuplicatePageViews || !Object.prototype.hasOwnProperty.call(te, e) || !te[e].has(o.id)) && (o.trackSingleOnly || (be({
                                                customData: t,
                                                eventData: n,
                                                eventName: e,
                                                pixel: o
                                            }), Object.prototype.hasOwnProperty.call(te, e) && te[e].add(o.id)))
                                        }
                                    }
                                    ...
                                    function Ee(e, t, n, r) {
                                        ...
                                        try {
                                            var i = e && e.userData || {},
                                                ...
                                                d = void 0,
                                                g = i.em;
                                            null != g && ve(g) && (1 === (d = ve(g)) && (u.em = X)), null != (g = a.em) && ve(g) && (1 === (d = ve(g)) && (c.em = X)), null != d && s.append("ped", d), s.append("ud", o({}, i, u), !0), s.append("udff", o({}, a, c), !0)
                                        } catch (t) {
                                            U.trigger(e)
                                        }
                                        ...
                                        })), s.append("it", K), d = e && "false" === e.codeless, s.append("coo", d), null != (i = ne.pluginConfig.getWithGlobalFallback(e ? e.id : null, "dataProcessingOptions")) && (u = i.dataProcessingCountry, a = i.dataProcessingOptions, c = i.dataProcessingState, s.append("dpo", a.join(",")), s.append("dpoco", u), s.append("dpost", c)), s
                                    }
                                    ...
                                    function be(e) {
                                        var r = e.customData,
                                            s = e.eventData,
                                            o = e.eventName;
                                        if (r = r || {}, null != (e = e.pixel) && m.pixelHasActiveBridge(e)) m.sendEvent(e, o, r);
                                        else {
                                            var i = Ee(e, o, r);
                                            if (null != s) {
                                                var a = s.eventID;
                                                s = s.event_id, a = null != a ? a : s, i.containsKey("eid") ? i.replaceEntry("eid", a) : i.append("eid", a)
                                            }
                                    ...
                                    function ye(e) {
                                        e.instance = ne, e.callMethod = ie, e._initHandlers = [], e._initsDone = {}, e.send = pe, e.getEventCustomParameters = Ee, e.addInitHandler = he, e.getState = me, e.init = ue, e.set = ae, e.loadPlugin = function(e) {
                                    ...
                                    l._initHandlers = [], l._initsDone = {}, q.onUnlocked((function() {
                                        _e()
                                    })), l.pixelId && (z = !0, ue(l.pixelId)), (z && $ || e.fbq !== e._fbq) && W({
                                            ...
                                            if (!0 !== l.disablePushState && r.pushState && r.replaceState) {
                                                var t = F((function() {
                                                    if (C = Y, (Y = n.href) !== C) {
                                                        ...
                                                        ie.call(e, "trackCustom", "PageView")
                                                    }
                                                }));
                                                y(r, "pushState", t), y(r, "replaceState", t), e.addEventListener("popstate", t, !1)
                                            }
                                        })(), "onpageshow" in e && e.addEventListener("pageshow", (function(e) {
                                            e.persisted && (e = new oe({
                                                allowDuplicatePageViews: !0
                                            }), ie.call(e, "trackCustom", "PageView"))
                                        }))
                                    })), ye(e.fbq), _e(), s.exports = {
                                        doExport: ye
                                    }, p.trigger()
                                }(), s.exports
                        }(e, t, n, r)
